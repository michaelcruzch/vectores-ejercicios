...
namespace Ejercicio_03
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //El programa deberá generar una cadena donde todas las ocurrencias del primer carácter dado hayan sido reemplazadas
            // por el segundo. Mostrar el resultado en pantalla. Ejemplo:
